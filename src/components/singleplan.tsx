				...
				<div className="bg-white rounded-t-[16px] h-full pb-10">
					<div className="bg-[#FFFFFF]">
						<Link href={"/dashboard/savings"}>
							<div className="flex items-center gap-2 p-10 border-b-[1px] border-b-[#F3F4F6]">
								<Image
									src={arrowleft}
									alt="arrow left"
						...
						<div className="md:flex justify-between items-center gap-5  md:gap-7 lg:gap-12">
							<div className="flex items-center md:basis-1/2 justify-between">
								<div className="flex items-center">
									...
									/>
									<div>
										<h2 className="text-[14px] font-[600] text-[#21003D] leading-[16px] mb-1">
											Ajayi Michael Oladimeji Akanbi
										</h2>
										<h3 className="text-[#9CA3AF] text-[12px] font-[400] leading-[16px]">{`<Ajayi/>`}</h3>
									</div>
								</div>
								<div>
									...
									<div className="">
										<DropdownMenu modal={false}>
											<DropdownMenuTrigger asChild>
												<button className="outline-none border-[1px] border-[#E5E7EB] px-5 py-2 flex justify-center items-center rounded-[4px]">
													House
