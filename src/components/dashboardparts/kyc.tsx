    ...
    <div className="bg-white p-10 rounded-[10px] border border-[#F3F4F6]">
      <Tabs defaultValue="tier-one" className="w-full">
        ...
        <TabsContent value="tier-one">
          <div className="flex flex-row gap-x-10">
            <div className="w-1/3">
              <h3 className="text-[#000] font-[500] leading-[20px] text-[12px]">National Identification Number (NIN Slip)</h3>
              <div className="relative inline-block">
                ...
                />
                <button className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 px-4 py-2 bg-[#000] text-[12px] text-white border border-[#fff] rounded-[5px] cursor-pointer z-10" onClick={() => handleImageClick(nin)}>
                  View
                </button>
              </div>
              <div className="flex flex-row gap-10">
                ...
                <div className="w-1/3">
                  <button className="border border-[#16A34A] rounded-[2px] text-[#16A34A] font-[500] leading-[20px] text-[12px] p-5 w-full flex items-center justify-center">
                    <Icon icon="mdi:tick-circle-outline" className="text-[#16A34A] me-2" />
                    <span>Approved</span>
                  </button>
                </div>
              </div>
            ...
            <div className="w-1/3">
              <h3 className="text-[#000] font-[500] leading-[20px] text-[12px]">User Details</h3>
              <div className="rounded-[8px] border border-[#E5E7EB] px-6 py-10 mt-4">
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <h2 className="text-[#9CA3AF] font-[500] leading-[20px] text-[12px]">First Name</h2>
                    <h2 className="text-[#000] font-[500] leading-[20px] text-[12px]">Ajayi</h2>
                  </div>
                  <div className="flex items-center justify-between mb-6">
                    <h2 className="text-[#9CA3AF] font-[500] leading-[20px] text-[12px]">Last Name</h2>
                    <h2 className="text-[#000] font-[500] leading-[20px] text-[12px]">Oluwadarasimi</h2>
                  </div>
                  <div className="flex items-center justify-between mb-6">
                    <h2 className="text-[#9CA3AF] font-[500] leading-[20px] text-[12px]">Date of Birth</h2>
                    <h2 className="text-[#000] font-[500] leading-[20px] text-[12px]">10/11/2023</h2>
                  </div>
                  <div className="flex items-center justify-between mb-6">
                    <h2 className="text-[#9CA3AF] font-[500] leading-[20px] text-[12px]">Gender</h2>
                    <h2 className="text-[#000] font-[500] leading-[20px] text-[12px]">M</h2>
                  </div>
                </div>
              </div>
            </div>
        ...
        <TabsContent value="tier-two">
          <div className="flex flex-row gap-x-10">
            <div className="w-1/3">
              <h3 className="text-[#000] font-[500] leading-[20px] text-[12px]">International Passport</h3>
              <div className="relative inline-block">
                <Image
                  src={nin}
                  alt="nin"
      ...
      {showPopup && (
        <div className="overlay">
          <div className="popup">
            <Image src={popupImageSrc} alt="Popup Image" className="popup-image mb-5" />
            <span className="close-btn cursor-pointer bg-white px-[9px] py-[4px] rounded-full" onClick={handleClosePopup}>
              &times;
            </span>
          </div>
        </div>
