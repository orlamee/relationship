												...
												<div className="flex flex-row gap-10 mt-5">
													...
													<div className="w-1/3">
														{NinData?.data?.approved ? (
															...
															<button className="border border-red-500 rounded-[2px] text-red-500 font-[500] leading-[20px] text-[12px] p-5 w-full flex items-center justify-center">
																<Icon
																	icon="mdi:tick-circle-outline"
									...
									<div>
										<div className="flex flex-row gap-x-10">
											<div className="w-1/3">
												...
												<div className="flex flex-row gap-10 mt-5">
													<div className="w-2/3">
														<div className="border border-[#F3F4F6] p-[18px] rounded-[2px] invisible">
															<h3>{utilityData?.data?.document_id}</h3>
														</div>
													</div>
													<div className="w-1/3">
														{utilityData?.data?.approved ? (
															<button className="border border-[#16A34A] rounded-[2px] text-[#16A34A] font-[500] leading-[20px] text-[12px] p-5 w-full flex items-center justify-center">
																<Icon
																	icon="mdi:tick-circle-outline"
																	className="text-[#16A34A] me-2"
